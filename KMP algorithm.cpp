// finding pattern in text  -> text.size() >= pattern.size() 
...
// 1 - we have to calc the LPS(Longest prefix which is equal to suffix at point i) for the patt
// 2 - then using that LPS vector we are trying to find our pattern in txt
// 3 - 
